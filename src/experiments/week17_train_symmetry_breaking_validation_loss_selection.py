...
OUTPUT_CSV = Path(
    ...
    "week17_symmetry_breaking_validation_loss_selection_training_summary.csv"
)

CHECKPOINT_DIR = Path(
    "results/models/gnn_node_scorer/"
    "week17_symmetry_breaking_validation_loss_selection_runs"
)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if epoch == 1 or epoch % 20 == 0:
            ...
            print(
                ...
                f"validation colors: {validation_coloring['total_colors']} | "
...
def main() -> None:
    print("Week 17 symmetry-breaking GNN training with validation-loss selection")
    print("--------------------------------------------------------------------")
    ...
    for seed in SEEDS:
        ...
        print(
            ...
            f"validation gap: {row['final_validation_total_gap_from_target']} | "
    ...
    print(f"Saved Week 17 validation-loss training summary to: {OUTPUT_CSV}")
