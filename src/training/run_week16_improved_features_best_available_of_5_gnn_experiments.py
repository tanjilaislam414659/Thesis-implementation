...
CHECKPOINT_DIR = Path(
    "results/models/gnn_node_scorer/week16_improved_features_best_available_of_5_runs"
)
...
def main() -> None:
    print("Week 16 improved-feature best-available-of-5 GNN node scorer experiment")
    print("---------------------------------------")
    print(f"Seeds: {SEEDS}")
    print()
