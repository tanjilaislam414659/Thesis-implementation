...
CHECKPOINT_DIR = Path(
    "results/models/gnn_node_scorer/week15_best_available_runs"
)
...
def train_single_run(seed: int) -> dict[str, object]:
    ...
    "data/processed/initial_graph_coloring_dataset/pyg_data_week15_best_available"
)
...
def main() -> None:
    print("Week 15 best-available-target GNN node scorer experiment")
    print("---------------------------------------")
    print(f"Seeds: {SEEDS}")
    print()
