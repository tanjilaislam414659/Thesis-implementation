...
from src.training.node_features_week16_improved_normalized import (
...
SPLIT_CSV = Path(
    ...
    "expanded_graph_split_week16_larger_extension.csv"
)

TARGET_CSV = Path(
    "data/processed/initial_graph_coloring_dataset/ordering_targets/"
    "best_available_of_5_ordering_targets_week16_larger_extension.csv"
)
...
GRAPH_ID_TO_MATRIX = {
    ...
    "bcsstk10": "bcsstk10.mtx",
    "bcsstk14": "bcsstk14.mtx",
    "bcsstk15": "bcsstk15.mtx",
    "dwt_234": "dwt_234.mtx",
    "dwt_361": "dwt_361.mtx",
    "dwt_419": "dwt_419.mtx",
...
def main() -> None:
    ...
    print("Building Week 16 larger-extension normalized-feature BEST_AVAILABLE_OF_5 PyG dataset")
