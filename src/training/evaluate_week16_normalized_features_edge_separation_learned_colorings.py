...
OUTPUT_CSV = Path(
    "results/tables/gnn_node_scorer/"
    "week16_normalized_features_edge_separation_learned_coloring_evaluation.csv"
)
...
def main() -> None:
    ...
    print("Week 16 normalized-feature edge-separation learned coloring evaluation")
    print("-------------------------------------------")
    ...
    print()
    print(f"Saved Week 16 normalized-feature edge-separation learned coloring evaluation to: {OUTPUT_CSV}")
