...
CHECKPOINT_DIR = Path(
    "results/models/gnn_node_scorer/week16_larger_extension_10_seeds_runs"
)
...
def main() -> None:
    print("Week 16 larger-extension best-available-of-5 GNN node scorer experiment with 10 seeds")
    print("---------------------------------------")
    print(f"Seeds: {SEEDS}")
    print()
