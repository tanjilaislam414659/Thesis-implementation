...
TRAINING_SUMMARY_CSV = Path(
    ...
    "week16_larger_extension_10_seeds_training_summary.csv"
)

OUTPUT_CSV = Path(
    "results/tables/gnn_node_scorer/"
    "week16_larger_extension_10_seeds_learned_coloring_evaluation.csv"
)
...
def main() -> None:
    ...
    print("Week 16 larger-extension 10-seeds learned coloring evaluation")
    print("-------------------------------------------")
    ...
    for graph_data in test_graphs:
        for training_row in training_rows:
            ...
            result_row = {
                ...
                "target_ordering": "BEST_AVAILABLE_OF_5_Larger_Extension_10_Seeds",
    ...
    print()
    print(f"Saved Week 16 larger-extension 10-seeds learned coloring evaluation to: {OUTPUT_CSV}")
