...
OUTPUT_CSV = Path(
    "results/tables/gnn_node_scorer/"
    "week16_normalized_features_best_available_of_5_learned_coloring_evaluation.csv"
)
...
def main() -> None:
    ...
    print("Week 16 normalized-feature best-available-of-5 learned coloring evaluation")
    print("-------------------------------------------")
    ...
    print()
    print(f"Saved Week 16 normalized-feature learned coloring evaluation to: {OUTPUT_CSV}")
