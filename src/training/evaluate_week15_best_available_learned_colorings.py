...
TRAINING_SUMMARY_CSV = Path(
    "results/tables/gnn_node_scorer/week15_best_available_training_summary.csv"
)

OUTPUT_CSV = Path(
    "results/tables/gnn_node_scorer/"
    "week15_best_available_learned_coloring_evaluation.csv"
)
...
def main() -> None:
    ...
    print("Week 15 best-available learned coloring evaluation")
    print("-------------------------------------------")
    ...
    for graph_data in test_graphs:
        for training_row in training_rows:
            ...
            result_row = {
                ...
                "target_ordering": "BEST_AVAILABLE_OF_3",
