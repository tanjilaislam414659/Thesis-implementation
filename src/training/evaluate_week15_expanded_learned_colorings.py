...
TRAINING_SUMMARY_CSV = Path(
    "results/tables/gnn_node_scorer/week15_expanded_training_summary.csv"
)

OUTPUT_CSV = Path(
    "results/tables/gnn_node_scorer/"
    "week15_expanded_learned_coloring_evaluation.csv"
)
...
def main() -> None:
    ...
    print("Week 15 expanded learned coloring evaluation")
    print("-------------------------------------------")
